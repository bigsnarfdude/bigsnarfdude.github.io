...
*Follow-up (2026-05-07): Per-head decomposition at L5/L15/L25/L37–38 shows the L37 authority signal completely turns over between SFT and IT — zero head overlap in the top-5. Head-level α-sweep ablation sprint in progress.*
